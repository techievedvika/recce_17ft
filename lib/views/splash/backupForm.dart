...
//                                     Expanded(
//                                       child: CustomTextFormField(
//                                         focusNode: _focusNodes[field['fields']
//                                             [0]['id']]!,
...
//                                 });
//                                                              print('length of');
//                                    print(invalidFieldIds.length);
//       if (invalidFieldIds.isNotEmpty) {
//   print('invalid ');
 
//         WidgetsBinding.instance.addPostFrameCallback((_) {
//              print('invalid 2'); 
//              print(invalidFieldIds.first);
//           final firstInvalidFieldId = invalidFieldIds.first;
//           _focusNodes['grades_taught'];
//           final focusNode = _focusNodes[firstInvalidFieldId];
          
//           if (focusNode != null) {
//             print('not null2 $focusNode');
...
//   //   // Scroll to the first invalid field
//   //   final invalidFieldId = _formValues.keys.firstWhere(
//   //     (id) {
//   //       return !_validateField(
//   //           {'id': id, 'type': 'text'}); // Adjust this check as needed
//   //     },
//   //     orElse: () => '',
//   //   );

//   //   if (invalidFieldId.isNotEmpty) {
//   //     final focusNode = _focusNodes[invalidFieldId];
//   //     if (focusNode != null) {
//   //       _scrollController.animateTo(
//   //         // Scroll to the focused field (adjust offset if needed)
//   //         _scrollController.position.pixels + 100,
//   //         duration: const Duration(milliseconds: 300),
//   //         curve: Curves.easeInOut,
//   //       );
...
//             ),
//             DynamicRadio(
//               focusNode: _focusNodes[otherOption['id']]!,
...
//                   const SizedBox(height: 10),
//                   CustomTextFormField(
//                     focusNode: _focusNodes[otherOption['otherOption']['id']]!,
//                     textController: TextEditingController(
